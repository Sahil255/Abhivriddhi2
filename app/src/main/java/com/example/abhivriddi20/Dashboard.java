...
public class Dashboard extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
   ...
   // String load_complaints = "http://192.168.56.1/abhivriddi2/total_complaints.php";
    ...
    public void file_complaint(View v)
    {

        startActivity(new Intent(Dashboard.this,complaint_register.class));
    }
    public void my_Complaints(View v)
    {

        startActivity(new Intent(Dashboard.this,my_complaints.class));
    }
    public void show_graph(View v)
    {

        startActivity(new Intent(Dashboard.this,graph.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        total=(TextView)findViewById(R.id.total_complaints_text);
        solved=(TextView)findViewById(R.id.solved_complaints_text);
       ...
       // load_total_complaints_table();
        ...
        dynamicListSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Dashboard.this, "item: "+dynamicListSpinner.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, load_complaints, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(Dashboard.this, "fffff", Toast.LENGTH_SHORT).show();
                    for (int i = 0; i < heroArray.length(); i++) {

                        JSONObject heroObject = heroArray.getJSONObject(i);


                        //solved=heroObject.getString("solved");
                        //registered=heroObject.getString("registered");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Dashboard.this, "Failed"+error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    */
    ...
    public void load_total_complaints_table1() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, load_complaints, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Dashboard.this, "Network issue, restart the app ", Toast.LENGTH_LONG).show();
